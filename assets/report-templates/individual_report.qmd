...
{{< downloadthis ext_meta_id_num_clustered_reads.tsv dname="ext_meta_id_num_clustered_reads" label="Download this table" icon="file-earmark-arrow-down" type="secondary" class="data-button" id="num_clustered_reads" >}}
...
{{< downloadthis ext_meta_id_skew_ratios.tsv dname="ext_meta_id_skew_ratios" label="Download this table" icon="file-earmark-arrow-down" type="secondary" class="data-button" id="mle_skews" >}}
