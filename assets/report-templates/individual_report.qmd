...
# save table
write_tsv(num_clustered_reads, paste0("meta_id_num_clustered_reads.tsv"))
...
{{< downloadthis meta_id_num_clustered_reads.tsv dname="meta_id_num_clustered_reads" label="Download this table" icon="file-earmark-arrow-down" type="secondary" class="data-button" id="num_clustered_reads" >}}
...
{{< downloadthis meta_id_skew_ratios.tsv dname="meta_id_skew_ratios" label="Download this table" icon="file-earmark-arrow-down" type="secondary" class="data-button" id="mle_skews" >}}
